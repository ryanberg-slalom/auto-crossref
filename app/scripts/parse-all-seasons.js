...
const SEASONS = [
  ...
  // ---- 2025 ----
  {
    ...
    EVENT_META: {
      ...
      8:  { date: '2025-09-20', title: 'Event 8 Dual Run',          runsPerSession: 3, sessions: 2, venue: 'michelin' },
    ...
    RUN_OVERRIDES: {
      ...
      8: [
        { run_number: 1, session: 'a', base_time: 39.784, scored_time: 39.784, cones: 0, dnf: false, rerun: false },
        { run_number: 2, session: 'a', base_time: 39.608, scored_time: 41.608, cones: 1, dnf: false, rerun: false },
        { run_number: 3, session: 'a', base_time: 38.331, scored_time: 38.331, cones: 0, dnf: false, rerun: false },
        { run_number: 4, session: 'b', base_time: 39.570, scored_time: 41.570, cones: 1, dnf: false, rerun: false },
        { run_number: 5, session: 'b', base_time: 39.975, scored_time: 39.975, cones: 0, dnf: false, rerun: false },
        { run_number: 6, session: 'b', base_time: 39.643, scored_time: 39.643, cones: 0, dnf: false, rerun: false },
      ],
    },
  },
